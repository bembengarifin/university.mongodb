...
class BlogPostDAO:
    ...
    def increment_likes(self, permalink, comment_ordinal):
        ...
        result = self.posts.update({"permalink": permalink}, {"$inc": {"comments." + str(comment_ordinal) + ".num_likes": 1}}, upsert=False, manipulate=False, safe=True)
        print "Updated like result: ", result
